...
/bin/sh /puppet/warden3/bin/register_sensor.sh -c "$(/puppet/metalib/bin/avahi_findservice.sh _warden-ca._tcp)" -n "cz.cesnet.flab.$(facter hostname).puppet-test-client" -d /opt/warden_server
