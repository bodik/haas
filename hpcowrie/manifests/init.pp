...
class hpcowrie (
	...
	$packages = ["git", "python-virtualenv", "libssl-dev", "libffi-dev", "build-essential", "libpython-dev", "python2.7-minimal", "authbind", "python3-dev", "sudo", "libmariadbclient-dev", "python-mysqldb"]
